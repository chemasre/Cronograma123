...
var checkboxText = "Iniciar [ProductName]";  // Text for the checkbox on the finished dialog
var filename = "Cronograma123.exe";   // The name of the executable to launch - change this to match the file you want to launch at the end of your setup
