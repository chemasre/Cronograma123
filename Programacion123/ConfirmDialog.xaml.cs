...
namespace Programacion123
{
    ...
    public partial class ConfirmDialog : Window
    {
        ...
        public void Init(ConfirmIconType _iconType, string _title, string _content, ConfirmChooseType _chooseType, Action<bool> _closeAction)
        {
            ...
            Separator1Option.Visibility = (_chooseType == ConfirmChooseType.acceptOnly ? Visibility.Visible : Visibility.Hidden);
            Separator2Options.Visibility = (_chooseType != ConfirmChooseType.acceptOnly ? Visibility.Visible : Visibility.Hidden);
